...
export async function exportInvoicePdf(
  ...
  try {
    ...
    const html = `<!doctype html><html><head><meta charset="utf-8"><title>Invoice ${escapeHtml(invoice.id)}</title><style>${sharedCss}
      .invoice{position:relative;min-height:297mm;height:auto;padding:11mm 11.5mm 9mm;font-size:9pt;line-height:1.25;color:#202020;overflow:visible}.invoice-main{display:block}.invoice-header{break-inside:avoid;page-break-inside:avoid}.top{display:grid;grid-template-columns:1fr 62mm;min-height:48mm}.logo{width:60mm;height:45mm;object-fit:contain}.title{text-align:right}.title h1{margin:0 0 7mm;color:#333;font-size:28pt;font-weight:400;line-height:1;letter-spacing:0}.title .number{display:block;font-size:7.2pt;color:#222;margin-bottom:7.5mm}.title p{margin:0 0 1.5mm;color:#222}.title strong{display:block;font-size:12pt;font-weight:700}.seller{margin-top:-6mm;margin-bottom:13mm;max-width:95mm;font-size:9pt;line-height:1.5;word-break:break-word;overflow-wrap:anywhere}.seller b{display:block;font-size:10pt;font-weight:400;line-height:1.35;overflow-wrap:anywhere;word-break:break-word}.parties{display:grid;grid-template-columns:1fr 65mm;gap:18mm;margin-bottom:10mm}.bill h3{font-size:10pt;font-weight:400;margin:0 0 4mm}.bill p{margin:0;font-size:9pt;line-height:1.5;word-break:break-word;overflow-wrap:anywhere}.meta{display:grid;grid-template-columns:29mm 1fr;gap:3.9mm 5mm;font-size:9pt;align-content:start}.meta span{text-align:right;color:#222;font-size:10pt}.meta b{font-size:9pt;font-weight:400;text-align:right;word-break:break-word;overflow-wrap:anywhere}.subject{margin:0 0 5mm;font-size:9pt;word-break:break-word;overflow-wrap:anywhere}.subject b{display:block;margin-top:5mm;font-size:9pt;font-weight:400;word-break:break-word;overflow-wrap:anywhere}.items{width:100%;border-collapse:collapse;table-layout:fixed;font-size:9pt}.items thead{display:table-header-group}.items tbody{break-inside:auto;page-break-inside:auto}.items tr{break-inside:avoid;page-break-inside:avoid}.items th{background:#262a2d;color:#fff;border-bottom:1px solid #262a2d;font-weight:400;text-align:center;padding:3.7mm 1.2mm;line-height:1.15;overflow-wrap:anywhere;word-break:break-word}.items td{border-bottom:.25mm solid #d7d7d7;padding:${itemRowPadding}mm 1.2mm;text-align:center;vertical-align:top;overflow-wrap:anywhere;word-break:break-word}.items .c-index{width:8mm}.items .c-desc{width:58mm;text-align:left}.items .c-qty{width:15mm;white-space:nowrap}.items .c-rate{width:20mm;white-space:nowrap}.items .c-taxable{width:24mm;white-space:nowrap}.items .c-tax-rate{width:18mm;white-space:nowrap}.items .c-tax{width:19mm;white-space:nowrap}.items .c-amount{width:25mm;white-space:nowrap}.line-description{display:block;white-space:pre-wrap;word-break:break-word;overflow-wrap:anywhere;max-width:100%}.invoice-footer{break-inside:auto;page-break-inside:auto}.totals{width:70mm;margin:7mm 0 0 auto;font-size:9pt;break-inside:avoid;page-break-inside:avoid}.total-line{display:grid;grid-template-columns:1fr 28mm;gap:12mm;padding:3.3mm 0;border-bottom:.25mm solid #e3e3e3}.total-line span{text-align:right}.total-line b{text-align:right;font-weight:400}.grand{font-weight:700}.grand b{font-weight:700}.invoice-lower{display:grid;grid-template-columns:1fr 70mm;gap:18mm;align-items:start;margin-top:8mm;break-inside:avoid;page-break-inside:avoid}.notes{max-width:76mm;font-size:7pt;line-height:1.28;word-break:break-word;overflow-wrap:anywhere}.notes h3{margin:0 0 2mm;font-size:10pt;font-weight:400}.notes p{margin:0 0 1.8mm;overflow-wrap:anywhere;word-break:break-word}.zatca{padding:0 2mm 3mm;text-align:center;color:#333;font-size:8pt}.zatca p{margin:0;line-height:1.35;overflow-wrap:anywhere;word-break:break-word}.qr{width:32mm;height:32mm;image-rendering:pixelated;margin:0 auto 2.5mm;display:block}@media print{html,body{height:auto;overflow:visible}.invoice{break-after:auto;min-height:0;height:auto;overflow:visible}.items td{padding:2mm 1.2mm}.items thead{display:table-header-group}}</style></head><body><main class="page invoice">
      <section class="invoice-main"><section class="invoice-header"><section class="top"><div><img class="logo" src="${quotationLogo.src}" alt="3 Stars"></div><div class="title"><h1>TAX INVOICE</h1><span class="number">#${escapeHtml(invoice.id)}</span><p>Balance Due</p><strong>${escapeHtml(currency)}${amount(balanceDue)}</strong></div></section>
