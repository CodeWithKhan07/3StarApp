...
export async function exportInvoicePdf(
  ...
  try {
    ...
    const html = `<!doctype html><html><head><meta charset="utf-8"><title>Invoice ${escapeHtml(invoice.id)}</title><style>${sharedCss}
      ...
      <style>.subject b,.notes p{white-space:pre-wrap;overflow-wrap:break-word;word-break:normal}.items td{min-width:0;overflow:hidden}.items td.c-desc{max-width:0;white-space:normal}.line-description{display:block;width:100%;max-width:100%;white-space:pre-wrap;overflow-wrap:break-word;word-break:normal;hyphens:none}.items td:not(.c-desc){white-space:nowrap}.items th{word-break:normal;overflow-wrap:break-word}</style>
