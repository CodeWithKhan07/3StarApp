...
export async function exportInvoicePdf(
  ...
  try {
    ...
    const html = `<!doctype html><html><head><meta charset="utf-8"><title>Invoice ${escapeHtml(invoice.id)}</title><style>${sharedCss}
      .invoice{position:relative;min-height:297mm;height:auto;padding:11mm 11.5mm 9mm;font-size:9pt;line-height:1.25;color:#202020;overflow:visible}.top{display:grid;grid-template-columns:1fr 62mm;min-height:48mm}.logo{width:60mm;height:45mm;object-fit:contain}.title{text-align:right}.title h1{margin:0 0 7mm;color:#333;font-size:28pt;font-weight:400;line-height:1;letter-spacing:0}.title .number{display:block;font-size:7.2pt;color:#222;margin-bottom:7.5mm}.title p{margin:0 0 1.5mm;color:#222}.title strong{display:block;font-size:12pt;font-weight:700}.seller{margin-top:-6mm;margin-bottom:13mm;max-width:95mm;font-size:9pt;line-height:1.5}.seller b{display:block;font-size:10pt;font-weight:400;line-height:1.35}.parties{display:grid;grid-template-columns:1fr 65mm;gap:18mm;margin-bottom:10mm}.bill h3{font-size:10pt;font-weight:400;margin:0 0 4mm}.bill p{margin:0;font-size:9pt;line-height:1.5}.meta{display:grid;grid-template-columns:29mm 1fr;gap:3.9mm 5mm;font-size:9pt;align-content:start}.meta span{text-align:right;color:#222;font-size:10pt}.meta b{font-size:9pt;font-weight:400;text-align:right}.subject{margin:0 0 5mm;font-size:9pt}.subject b{display:block;margin-top:5mm;font-size:9pt;font-weight:400}.items{width:100%;border-collapse:collapse;table-layout:fixed;font-size:9pt;break-inside:auto;page-break-inside:auto}.items thead{display:table-header-group}.items tbody{break-inside:auto;page-break-inside:auto}.items tr{break-inside:avoid;page-break-inside:avoid}.items th{background:#262a2d;color:#fff;border-bottom:1px solid #262a2d;font-weight:400;text-align:center;padding:3.7mm 1.2mm;line-height:1.15;overflow-wrap:anywhere}.items td{border-bottom:.25mm solid #d7d7d7;padding:${itemRowPadding}mm 1.2mm;text-align:center;vertical-align:top;overflow-wrap:anywhere}.items .c-index{width:8mm}.items .c-desc{width:58mm;text-align:left}.items .c-qty{width:15mm}.items .c-rate{width:20mm}.items .c-taxable{width:24mm}.items .c-tax-rate{width:18mm}.items .c-tax{width:19mm}.items .c-amount{width:25mm}.invoice-footer{display:grid;grid-template-columns:minmax(0,1fr) 70mm;gap:16mm;align-items:start;margin-top:7mm;break-inside:avoid;page-break-inside:avoid}.totals{grid-column:2;grid-row:1;width:70mm;margin:0;font-size:9pt;break-inside:avoid;page-break-inside:avoid}.total-line{display:grid;grid-template-columns:1fr 28mm;gap:12mm;padding:3.3mm 0;border-bottom:.25mm solid #e3e3e3}.total-line span{text-align:right}.total-line b{text-align:right;font-weight:400}.grand{font-weight:700}.grand b{font-weight:700}.invoice-lower{grid-column:1;grid-row:1;display:flex;flex-direction:column;align-items:flex-start;min-width:0;margin:0;break-inside:avoid;page-break-inside:avoid}.notes{width:100%;max-width:86mm;margin-top:3mm;font-size:7pt;line-height:1.28;break-inside:avoid;page-break-inside:avoid}.notes h3{margin:0 0 2mm;font-size:10pt;font-weight:400}.notes p{margin:0 0 1.8mm}.zatca{max-width:68mm;padding:0;text-align:left;color:#333;font-size:8pt;break-inside:avoid;page-break-inside:avoid}.zatca p{margin:0;line-height:1.35;overflow-wrap:normal}.qr{width:32mm;height:32mm;image-rendering:pixelated;margin:0 0 2mm;display:block}@media print{html,body{height:auto;overflow:visible}.invoice{break-after:auto;page-break-after:auto;min-height:296.5mm;height:auto;overflow:visible}.items thead{display:table-header-group}.items tfoot{display:table-footer-group}}</style></head><body><main class="page invoice">
      <style>.subject b,.notes p{white-space:pre-wrap;overflow-wrap:anywhere;word-break:break-word}.items td{min-width:0;overflow:hidden}.items td.c-desc{max-width:0;white-space:normal}.line-description{display:block;width:100%;max-width:100%;white-space:pre-wrap;overflow-wrap:anywhere;word-break:break-all}.items td:not(.c-desc){white-space:nowrap}</style>
